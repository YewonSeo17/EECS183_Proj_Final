...
public:
    ...
    *          The 's' means that the elevator is currently servicing, 
    *          with target floor being the number after the 's'
    *          The 'w' means that the elevator is waiting, so it has no target 
    *          floor and is ready to service requests
